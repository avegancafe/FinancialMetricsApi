...
(* OASIS_START *)
(* DO NOT EDIT (digest: 41fab413cbf58a879a1107504594ca9e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "REST API for calculating financial metrisc";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("opium.unix", None)];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "pN\151D\232'9\168\141\186:\210\234m\186z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
